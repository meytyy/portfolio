...
const packs: Packs = {
  ru: {
    ...
    contact_form_title: 'Написать мне',
    contact_form_name: 'Имя',
    contact_form_name_placeholder: 'Как к вам обращаться',
    contact_form_message: 'Сообщение',
    contact_form_message_placeholder: 'Расскажите о задаче или проекте',
    contact_form_submit: 'Отправить сообщение',
    contact_form_sending: 'Отправка…',
    contact_form_success: 'Сообщение отправлено. Я свяжусь с вами в ближайшее время.',
    contact_form_error: 'Не удалось отправить. Напишите напрямую:',
  ...
  en: {
    ...
    contact_form_name_placeholder: 'How should I address you?',
    contact_form_message: 'Message',
    contact_form_message_placeholder: 'Tell me about your task or project',
    contact_form_submit: 'Send message',
    contact_form_sending: 'Sending…',
    contact_form_success: 'Message sent. I will get back to you soon.',
    contact_form_error: 'Could not send the message. Email me directly:',
    what_i_do: 'What I do',
